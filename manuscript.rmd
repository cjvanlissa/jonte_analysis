---
title: "Exploring Heterogeneity in MetaBus Effect Sizes"
...
Below are the results for the final model, estimated on the complete dataset using optimal tuning parameters determined via cross-validation:



```{r}
tar_load(final_model)
knitr::kable(final_model$coefficients, digits = 2)
```
