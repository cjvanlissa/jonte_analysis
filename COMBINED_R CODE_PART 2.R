...
setwd("C:/Users/zip322/Downloads/FINAL Analysis File")
...
# ---------- Load and prepare ----------
dat <- read_excel("metadata.xlsx", sheet = "Sheet1", skip = 1) %>%
...
# Save the exact same data you use in R to drive the RF step
write.csv(dat_rf, "dat_rf_with_resid.csv")
...
vi_tbl  <- enframe(vi_core, name = "variable", value = "perm_importance")
